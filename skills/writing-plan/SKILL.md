...
- ❌ **plan.meta.json の `plan_started_at` / `plan_completed_at` を同値で書く** (2026-04-20 tmux-dashboard-mvp learn §5.1、未計測扱いと等価。§5.3 の取得手順で skill 起動直後と Plan 保存直前の 2 回に分けて取得する)
